      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 rounded-xl border border-[#2A2A45] text-slate-300 hover:border-[#6C63FF]/50 hover:text-[#6C63FF] hover:bg-[#6C63FF]/5 transition-all duration-300 font-medium group shadow-lg"
          >
