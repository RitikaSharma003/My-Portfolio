      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            I specialize in{" "}
            <span className="text-slate-900 dark:text-white font-semibold">React and Modern JavaScript</span>, leveraging
            best practices to create scalable and maintainable projects. My experience spans from
            small business websites to{" "}
            <span className="text-slate-900 dark:text-white font-semibold">complex front-end systems</span>.
          </p>
        </motion.div>
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 rounded-xl border border-dark-border text-slate-600 dark:text-slate-300 hover:border-[#6C63FF]/50 hover:text-[#6C63FF] hover:bg-[#6C63FF]/5 transition-all duration-300 font-medium group shadow-lg"
          >
